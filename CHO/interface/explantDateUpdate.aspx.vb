...
Partial Class interface_explantDateUpdate
    ...
    Protected Sub explantToOPM_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles explantToOPM.Click
        ...
        Dim dtUpdateTo As SqlDataAdapter = New SqlDataAdapter("SELECT * FROM Esch_CQ_tbl_explant", conn)
        ...
        Dim dtFrom0 As SqlDataAdapter = New SqlDataAdapter("SELECT txt_orgn_code,int_status_key,int_line_no,txt_order_key,dat_etd,dat_new_explant FROM Esch_CQ_tbl_orders " & sqlWhereClause.ToString(), conn)
        ...
        Dim dtFrom1 As SqlDataAdapter = New SqlDataAdapter("SELECT * FROM Esch_CQ_tbl_explant_history ", conn)
            ...
            If recordsCount > 0 Then
                ...
                For Each dtrow0 As DataRow In dtTableFrom0.Rows 'get order line data from table Esch_CQ_tbl_orders
                    ...
                    If dtHistory.Count > 0 Then
                        ...
                        End Try
                    Else 'no record exist before,need create new record both Esch_CQ_tbl_explant and Esch_CQ_tbl_explant_history
                        Try
                            Dim newRow As DataRow = dtTableUpdateTo.NewRow()
                ...
                'extract all the data from Esch_CQ_tbl_explant to convert to a string in order to write it to a file
        ...
        'write data back to table Esch_CQ_tbl_explant
        ...
        If continueToUpdate Then
            ...
            Try
                ...
                dtFrom1.Update(dtTableFrom1) 'write data back to Esch_CQ_tbl_explant_history
            Catch ex As Exception
                continueToUpdate = False
        ...
        'write the changes on order status back to Esch_CQ_tbl_orders
        If continueToUpdate Then
            ...
            Try
                ...
                Next
                dtFrom0.Update(dtTableFrom0) 'write data back to Esch_CQ_tbl_explant_history
            Catch ex As Exception
