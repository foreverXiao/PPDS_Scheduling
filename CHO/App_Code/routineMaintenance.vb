...
Public Class routineMaintenance
    ...
    Protected Sub clearAgedScrewMark()
        ...
        Dim dtAdapterFrom As SqlDataAdapter = New SqlDataAdapter("SELECT txt_order_key FROM Esch_CQ_tbl_orders ", conn)
        Dim dtTableFrom As DataTable = New DataTable
        dtAdapterFrom.Fill(dtTableFrom)

        Dim dtAdapterTo1 As SqlDataAdapter = New SqlDataAdapter("SELECT * FROM Esch_CQ_tbl_prductn_prmtr ", conn)
