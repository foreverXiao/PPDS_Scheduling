<%@ Page  aspcompat="true"  Title="Output per line and item" Language="VB" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="false" CodeFile="outputPerLinePerItem.aspx.vb" Inherits="Makerelated_outputPerLinePerItem" Theme="Monochrome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    <asp:Label ID="Message"
      ...
      <asp:ListView ID="LV1" runat="server" ClientIDMode="Static" 
          DataSourceID="SDS1" DataKeyNames="txt_item_no,txt_line_no" 
    ...
    SelectCommand="SELECT [txt_item_no], [txt_line_no], [int_rate], [txtRemark] FROM [Esch_CQ_tbl_output_by_line_by_item]" 
    DeleteCommand="DELETE FROM [Esch_CQ_tbl_output_by_line_by_item] WHERE ([txt_item_no] = ?) AND ([txt_line_no] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_CQ_tbl_output_by_line_by_item] SET [int_rate] = ?, [txtRemark] = ? WHERE ([txt_item_no] = ?) AND ([txt_line_no] = ?)" 
            
            
            InsertCommand="INSERT INTO [Esch_CQ_tbl_output_by_line_by_item] ([txt_item_no], [txt_line_no], [int_rate], [txtRemark]) VALUES (?, ?, ?, ?)" >
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="int_rate" Type="Int16" />
