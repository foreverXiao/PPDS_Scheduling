...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_CQ_tbl_colorCode] ORDER BY [color]" 
    DeleteCommand="DELETE FROM [Esch_CQ_tbl_colorCode] WHERE ([color] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_CQ_tbl_colorCode] SET [red] = ?, [green] = ?, [blue] = ?, [tranparent] = ?, [commonName] = ? WHERE ([color] = ?)" 
            
            
            
            
            InsertCommand="INSERT INTO [Esch_CQ_tbl_colorCode] ([color], [red], [green], [blue], [tranparent], [commonName]) VALUES (?, ?, ?, ?, ?, ?)" >
