...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT [int_line_no], [int_rate], [txtRemark] FROM [Esch_CQ_tbl_output_by_line_only]" 
    DeleteCommand="DELETE FROM [Esch_CQ_tbl_output_by_line_only] WHERE ([int_line_no] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_CQ_tbl_output_by_line_only] SET [int_rate] = ?, [txtRemark] = ? WHERE ([int_line_no] = ?)" 
            
            
            
            
            InsertCommand="INSERT INTO [Esch_CQ_tbl_output_by_line_only] ([int_line_no], [int_rate], [txtRemark]) VALUES (?, ?, ?)" >
