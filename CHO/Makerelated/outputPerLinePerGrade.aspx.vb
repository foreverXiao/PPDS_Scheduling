...
Partial Class Makerelated_outputPerLinePerGrade
    ...
    'generate a new table Esch_CQ_tbl_assign_line_by_grade  which shows which production lines can produce specific grade
    Public Sub GradeAndItsQualifiedProductionLines()
        ...
        Dim dtUpdateFrom1 As SqlDataAdapter = New SqlDataAdapter("SELECT * FROM Esch_CQ_tbl_output_by_line_by_grade", connParam)
        Dim dtUpdateTo As SqlDataAdapter = New SqlDataAdapter("SELECT * FROM Esch_CQ_tbl_assign_line_by_grade", connParam)
