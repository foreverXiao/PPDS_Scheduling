...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_CQ_tbl_MOQ] ORDER BY [groupName], [seqPerGroup]" 
    DeleteCommand="DELETE FROM [Esch_CQ_tbl_MOQ] WHERE ([groupName] = ?) AND ([seqPerGroup] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_CQ_tbl_MOQ] SET [headerName] = ?, [relationOperator] = ?, [conditionValue] = ?, [remarkToBeAdded] = ? WHERE ([groupName] = ?) AND ([seqPerGroup] = ?)" 
            
            
            InsertCommand="INSERT INTO [Esch_CQ_tbl_MOQ] ([groupName], [seqPerGroup], [headerName], [relationOperator], [conditionValue], [remarkToBeAdded]) VALUES (?, ?, ?, ?, ?, ?)" >
