...
Partial Class SCMrelated_ExportForGoldenRuleReport
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim dtAdapter1 As SqlDataAdapter = New SqlDataAdapter("SELECT txt_order_key,txt_lot_no,txt_allocated_lots,dat_finish_date,int_line_no,flt_order_qty,planned_production_qty From Esch_CQ_tbl_orders WHERE int_status_key Not In ('cancelled','invoiced')  ORDER BY int_line_no,dat_start_date", conn)
