<%@ Page  aspcompat="true"  Title="orders for Order fulfillment" Language="VB" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="false" CodeFile="ordersForOF.aspx.vb" Inherits="SCMrelated_ordersForOF" Theme="Monochrome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    <b>Order in dummy line or its start time or finish time&nbsp;&nbsp;between</b>&nbsp;&nbsp;&nbsp;
    ...
    <hr style="color:white;height:1px" />
        <asp:Button ID="Download1" runat="server" ClientIDMode="Static" 
            ...
            ViewStateMode="Disabled" /><br /><asp:Label ID="StatusLabel" runat="server" Text=""></asp:Label><br />
