...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_CQ_tbl_currencyCustoms] ORDER BY [groupName], [sequencePerGroup]" 
    DeleteCommand="DELETE FROM [Esch_CQ_tbl_currencyCustoms] WHERE ([groupName] = ?) AND ([sequencePerGroup] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_CQ_tbl_currencyCustoms] SET [columnName] = ?, [relationOperator] = ?, [conditionValue] = ?, [extraDays] = ? WHERE ([groupName] = ?) AND ([sequencePerGroup] = ?)" 
                                                                          
            
            
            
            InsertCommand="INSERT INTO [Esch_CQ_tbl_currencyCustoms] ([groupName], [sequencePerGroup], [columnName], [relationOperator], [conditionValue], [extraDays]) VALUES (?, ?, ?, ?, ?, ?)" >
