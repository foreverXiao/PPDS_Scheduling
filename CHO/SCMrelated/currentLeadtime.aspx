...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT [Lead_time_Group], [Production_line], [lngDaily_output], [lnglead_time], [datStartTime], [sng_coefficient] FROM [Esch_CQ_tbl_Lead_Time]" 
    DeleteCommand="DELETE FROM [Esch_CQ_tbl_Lead_Time] WHERE ([Lead_time_Group] = ?) AND ([Production_line] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_CQ_tbl_Lead_Time] SET [lngDaily_output] = ?, [lnglead_time] = ?, [datStartTime] = ?, [sng_coefficient] = ? WHERE ([Lead_time_Group] = ?) AND ([Production_line] = ?)" 
                                           
            
            
            
            
            InsertCommand="INSERT INTO [Esch_CQ_tbl_Lead_Time] ([Lead_time_Group], [Production_line], [lngDaily_output], [lnglead_time], [datStartTime], [sng_coefficient]) VALUES (?, ?, ?, ?, ?, ?)" >
