<%@ Page  aspcompat="true"  Title="VIP rules" Language="VB" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="false" CodeFile="VIPrule.aspx.vb" Inherits="SCMrelated_VIPrule" Theme="Monochrome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    ClientIDMode="Static" ViewStateMode="Disabled" EnableViewState="False" OnClientClick="return confirm('Are you sure you want to delete it?');"  />
    <asp:Button runat="server" 
    ...
    SelectCommand="SELECT [VIPgroup], [headerName], [Operator], [VIPCondition], [DaysOfCommittedLeadtime], [DaysAdvanceBeforeRevision], [ReservedCapPerWeek] FROM [Esch_CQ_tbl_VIP_lead_time] ORDER BY [VIPgroup], [DaysOfCommittedLeadtime]" 
    DeleteCommand="DELETE FROM [Esch_CQ_tbl_VIP_lead_time] WHERE (([VIPgroup] = ?)) AND (([headerName] = ?)) AND (([Operator] = ?)) AND (([VIPCondition] = ?))" 
                                  
            UpdateCommand="UPDATE [Esch_CQ_tbl_VIP_lead_time] SET [DaysOfCommittedLeadtime] = ?, [DaysAdvanceBeforeRevision] = ?, [ReservedCapPerWeek] = ? WHERE (([VIPgroup] = ?)) AND (([headerName] = ?)) AND (([Operator] = ?)) AND (([VIPCondition] = ?))" 
            ...
            InsertCommand="INSERT INTO [Esch_CQ_tbl_VIP_lead_time] ([VIPgroup], [headerName], [Operator], [VIPCondition], [DaysOfCommittedLeadtime], [DaysAdvanceBeforeRevision], [ReservedCapPerWeek]) VALUES (?, ?, ?, ?, ?, ?, ?)" >
