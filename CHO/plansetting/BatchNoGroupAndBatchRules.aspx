...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_CQ_tbl_batch_no_group_and_batch_rules] ORDER BY [int_Batch_NO_group]" 
    DeleteCommand="DELETE FROM [Esch_CQ_tbl_batch_no_group_and_batch_rules] WHERE (([int_Batch_NO_group] = ?))" 
                                  
            UpdateCommand="UPDATE [Esch_CQ_tbl_batch_no_group_and_batch_rules] SET [txt_minimum_no] = ?, [txt_current_no] = ?, [txt_last_no] = ?, [txt_maximum_no] = ? WHERE (([int_Batch_NO_group] = ?))" 
            ...
            InsertCommand="INSERT INTO [Esch_CQ_tbl_batch_no_group_and_batch_rules] ([int_Batch_NO_group], [txt_minimum_no], [txt_current_no], [txt_last_no], [txt_maximum_no]) VALUES (?, ?, ?, ?, ?)" >
