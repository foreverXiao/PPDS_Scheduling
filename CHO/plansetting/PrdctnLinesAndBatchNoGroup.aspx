...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_CQ_tbl_production_lines_and_batch_no_group]" 
    DeleteCommand="DELETE FROM [Esch_CQ_tbl_production_lines_and_batch_no_group] WHERE ([int_Batch_NO_group] = ?) AND ([sequencePerBatchNoGroup] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_CQ_tbl_production_lines_and_batch_no_group] SET [columnName] = ?, [relationOperator] = ?, [conditionValue] = ? WHERE ([int_Batch_NO_group] = ?) AND ([sequencePerBatchNoGroup] = ?)" 
                                                                          
            
            
            
            InsertCommand="INSERT INTO [Esch_CQ_tbl_production_lines_and_batch_no_group] ([int_Batch_NO_group], [sequencePerBatchNoGroup], [columnName], [relationOperator], [conditionValue]) VALUES (?, ?, ?, ?, ?)" >
