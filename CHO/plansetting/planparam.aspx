...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT [category], [paramname], [paramvalue] FROM [Esch_CQ_tbl_plnprmtr] ORDER BY [category], [paramname] DESC" 
    DeleteCommand="DELETE FROM [Esch_CQ_tbl_plnprmtr] WHERE ([category] = @original_category) AND ([paramname] = @original_paramname)" 
                                  
            UpdateCommand="UPDATE [Esch_CQ_tbl_plnprmtr] SET [paramvalue] = @paramvalue WHERE ([category] = @original_category) AND ([paramname] = @original_paramname) " 
                                           
            
            
            
            InsertCommand="INSERT INTO [Esch_CQ_tbl_plnprmtr] ([category], [paramname], [paramvalue]) VALUES (@category, @paramname, @paramvalue)" >
