...
Partial Class usermanage_changepassword
    ...
    Protected Sub btSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btSubmit.Click
        ...
        Try
            ...
            cmd0.CommandText = "SELECT * FROM [Esch_CQ_tbl_userrole] WHERE [password] = '" & oldpsswrd.Text & "' AND [user_name] = '" & tbUsNm.Text & "'"


            cmd.Connection = conn
            cmd.CommandText = "UPDATE [Esch_CQ_tbl_userrole] SET [password] = '" & tbNewpswrdAgn.Text & "' WHERE [user_name] = '" & tbUsNm.Text & "'"
