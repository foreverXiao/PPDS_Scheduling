...
Partial Class dragDrop_DataExchange
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If CacheFrom("schedule") Is Nothing Then 'need refresh data for planning period parameter
            ...
            Dim command1 As New SqlCommand("Select paramname, paramvalue From Esch_CQ_tbl_plnprmtr where category = 'schedule'", connParam)
        ...
        If autOp Then 'the user has the right to do planning on this production line
            ...
            If actionRequested = "updateorder" Then
                query1 = "Select * From Esch_CQ_tbl_orders Where txt_order_key  ='" & Request.Params("orderkey") & "'"
            ...
            If actionRequested = "updateorderinbatch" Then
                ...
                query1 = "Select dat_start_date,dat_finish_date,txt_order_key From Esch_CQ_tbl_orders  Where txt_order_key in ('" & Request.Params("frstslctnID") & "','" & Request.Params("scndslctnID") & "') Order by dat_start_date ASC,dat_finish_date ASC,txt_order_key ASC"
                ...
                query1 = "Select * From Esch_CQ_tbl_orders Where (" & DAT_START_DATE & " between " & dateSeparator & minDatetime & dateSeparator & " And " & dateSeparator & maxDatetime & dateSeparator & ") And ( int_line_no =  '" & Request.Params("lineno") & "' ) Order by " & DAT_START_DATE & " ASC," & DAT_FINISH_DATE & " ASC,txt_order_key ASC"
                Dim dtAdapter1 As SqlDataAdapter = New SqlDataAdapter(query1, conn)
                Dim cmdbAccessCmdBuilder As New SqlCommandBuilder(dtAdapter1)
                dtAdapter1.UpdateCommand = cmdbAccessCmdBuilder.GetUpdateCommand()
            ...
            If actionRequested = "updateorderinbatchA" Then
                ...
                query1 = "Select * From Esch_CQ_tbl_orders Where (" & DAT_START_DATE & " between " & dateSeparator & minDatetime & dateSeparator & " And " & dateSeparator & maxDatetime & dateSeparator & ") And ( int_line_no =  '" & Request.Params("lineno") & "' ) Order by " & DAT_START_DATE & " DESC," & DAT_FINISH_DATE & " DESC,txt_order_key ASC"
                Dim dtAdapter1 As SqlDataAdapter = New SqlDataAdapter(query1, conn)
                Dim cmdbAccessCmdBuilder As New SqlCommandBuilder(dtAdapter1)
                dtAdapter1.UpdateCommand = cmdbAccessCmdBuilder.GetUpdateCommand()
            ...
            If actionRequested = "moveingroup" Then
                ...
                query1 = "Select * From Esch_CQ_tbl_orders Where (dat_start_date between " & dateSeparator & minDatetimeSt & dateSeparator & " And " & dateSeparator & maxDatetime & dateSeparator & ")  And  ( int_line_no =  '" & Request.Params("lineno") & "')  Order by dat_start_date ASC,dat_finish_date ASC,txt_order_key ASC"
                Dim dtAdapter1 As SqlDataAdapter = New SqlDataAdapter(query1, conn)
                Dim cmdbAccessCmdBuilder As New SqlCommandBuilder(dtAdapter1)
                dtAdapter1.UpdateCommand = cmdbAccessCmdBuilder.GetUpdateCommand()
            ...
            If actionRequested = "pullscrew" Then
                query1 = "select * From Esch_CQ_tbl_prductn_prmtr where  txt_order_key = '" & Request.Params("orderkey") & "'"
                Dim dtAdapter1 As SqlDataAdapter = New SqlDataAdapter(query1, conn)
                Dim cmdbAccessCmdBuilder As New SqlCommandBuilder(dtAdapter1)
        ...
        If actionRequested = "contextMenu" Then
            ...
            command.CommandText = "SELECT dat_start_date FROM Esch_CQ_tbl_orders WHERE txt_order_key = '" & Request.Params("orderkey") & "'"
            reader = command.ExecuteReader()
