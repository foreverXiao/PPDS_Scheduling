...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    DeleteCommand="DELETE FROM [Esch_CQ_tbl_MTI_add] WHERE [sequence] = ?" 
            ...
            UpdateCommand="UPDATE [Esch_CQ_tbl_MTI_add] SET [decideToAdd] = ?, [txt_order_no] = ?, [txt_order_line_no] = ?, [txt_local_so] = ?, [item] = ?, [quantity] = ?, [line] = ?, [txt_gl_class] = ?, [startDate] = ?, [remark] = ? WHERE [sequence] = ?" 
            ...
            InsertCommand="INSERT INTO [Esch_CQ_tbl_MTI_add] ([decideToAdd], [sequence], [txt_order_no], [txt_order_line_no], [txt_local_so], [item], [quantity], [line], [txt_gl_class], [startDate], [remark]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" >
