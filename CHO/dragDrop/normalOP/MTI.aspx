...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_CQ_tbl_MTI_add] ORDER BY [sequence]" 
    DeleteCommand="DELETE FROM [Esch_CQ_tbl_MTI_add] WHERE [sequence] = ?" 
                                  
            UpdateCommand="UPDATE [Esch_CQ_tbl_MTI_add] SET [decideToAdd] = ?, [txt_order_no] = ?, [txt_order_line_no] = ?, [txt_local_so] = ?, [txt_currency] = ?, [txt_package_code] = ?, [txt_ship_method] = ?, [item] = ?, [quantity] = ?, [line] = ?, [txt_gl_class] = ?, [startDate] = ?, [remark] = ? WHERE [sequence] = ?" 
            ...
            InsertCommand="INSERT INTO [Esch_CQ_tbl_MTI_add] ([decideToAdd], [sequence], [txt_order_no], [txt_order_line_no], [txt_local_so], [txt_currency], [txt_package_code], [txt_ship_method],  [item], [quantity], [line], [txt_gl_class], [startDate], [remark]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" >
