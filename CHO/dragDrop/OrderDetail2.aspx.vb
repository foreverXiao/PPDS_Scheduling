...
Partial Class dragDrop_OrderDetail
    ...
    Public Overrides Function dataDeletedFromDatabaseTablePerExcelData(ByRef StatusLabel As Label, ByRef SDS1 As SqlDataSource, ByRef LV1 As ListView, ByVal filepath As String, ByVal filename As String, ByVal flextsn As String, ByRef continueOrnot As Boolean) As String
        ...
        If continue1 Then
            ...
            Dim dtAdapter1 As SqlDataAdapter = New SqlDataAdapter("SELECT * FROM Esch_Sh_tbl_orders ", conn)
    ...
    Public Overrides Function dataValidityCheck(ByRef dtTbl As DataTable) As String
        ...
        Try
            ...
            For Each rowexcel As DataRow In dtTbl.Rows
                ...
                'If Not (DBNull.Value.Equals(rowexcel("txt_lot_no")) OrElse String.IsNullOrEmpty(rowexcel("txt_lot_no"))) Then
    ...
    Protected Function oneTimeRoutinePlanning(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ListViewUpdateEventArgs) As String
        ...
        Try
            ...
            If True Then
                ...
                'Dim dtUpdateTo As SqlDataAdapter = New SqlDataAdapter("SELECT txt_order_key,txt_item_no,dat_rdd,dat_etd,txt_currency,txt_destination,txt_ship_method,txt_end_user FROM Esch_Sh_tbl_orders WHERE txt_order_key = '" & e.OldValues("txt_order_no") & "-" & e.OldValues("txt_order_line_no") & "'", conn)
                Dim dtUpdateTo As SqlDataAdapter = New SqlDataAdapter("SELECT txt_order_key,txt_item_no,dat_rdd,dat_etd,txt_currency,txt_destination,txt_ship_method,txt_end_user FROM Esch_CQ_tbl_orders WHERE txt_order_key = '" & e.Keys("txt_order_key") & "'", conn)
            ...
            If True Then
                ...
                'Dim dtUpdateTo As SqlDataAdapter = New SqlDataAdapter("SELECT txt_order_key,flt_actual_qty_man,flt_actual_completed,planned_production_qty FROM Esch_Sh_tbl_orders WHERE txt_order_key = '" & e.OldValues("txt_order_no") & "-" & e.OldValues("txt_order_line_no") & "'", conn)
                Dim dtUpdateTo As SqlDataAdapter = New SqlDataAdapter("SELECT txt_order_key,flt_actual_qty_man,flt_actual_completed,planned_production_qty FROM Esch_CQ_tbl_orders WHERE txt_order_key = '" & e.Keys("txt_order_key") & "'", conn)
                Dim dtTable As DataTable = New DataTable
            ...
            If True Then
                ...
                'Dim dtUpdateTo As SqlDataAdapter = New SqlDataAdapter("SELECT * FROM Esch_Sh_tbl_orders WHERE txt_order_key = '" & e.OldValues("txt_order_no") & "-" & e.OldValues("txt_order_line_no") & "'", conn)
                Dim dtUpdateTo As SqlDataAdapter = New SqlDataAdapter("SELECT * FROM Esch_CQ_tbl_orders WHERE txt_order_key = '" & e.Keys("txt_order_key") & "'", conn)
                Dim dtTable As DataTable = New DataTable
