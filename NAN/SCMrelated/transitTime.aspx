...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT [txt_currency], [txt_ship_to], [txt_destination], [txt_ship_method], [flt_transit], [flt_actual] FROM [Esch_Na_tbl_transit]" 
    DeleteCommand="DELETE FROM [Esch_Na_tbl_transit]  WHERE ([txt_currency] = ?) AND ([txt_destination] = ?) AND ([txt_ship_method] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Na_tbl_transit] SET [txt_ship_to] = ?, [flt_transit] = ?, [flt_actual] = ?  WHERE ([txt_currency] = ?) AND ([txt_destination] = ?) AND ([txt_ship_method] = ?)" 
                                           
            InsertCommand="INSERT INTO [Esch_Na_tbl_transit] ([txt_currency], [txt_ship_to], [txt_destination], [txt_ship_method], [flt_transit], [flt_actual]) VALUES (?, ?, ?, ?, ?, ?)" >
