...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_Na_tbl_remarkPerCondition]" 
    DeleteCommand="DELETE FROM [Esch_Na_tbl_remarkPerCondition] WHERE ([groupName] = ?) AND ([sequence] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Na_tbl_remarkPerCondition] SET [headerName] = ?, [relationOperator] = ?, [conditionValue] = ?, [remarkToBeAdded] = ? WHERE ([groupName] = ?) AND ([sequence] = ?)" 
                                           
            
            
            
            InsertCommand="INSERT INTO [Esch_Na_tbl_remarkPerCondition] ([groupName], [sequence], [headerName], [relationOperator], [conditionValue], [remarkToBeAdded]) VALUES (?, ?, ?, ?, ?, ?)" >
