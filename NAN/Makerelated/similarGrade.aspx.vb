...
Partial Class Makerelated_similarGrade
    ...
    Protected Sub LV1_ItemUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ListViewUpdateEventArgs) Handles LV1.ItemUpdating
        ...
        If String.IsNullOrEmpty(e.NewValues("typicalGrade")) Then
            messageText.Append("Empty value in field typicalGrade is not allowed.<br />")
        End If
