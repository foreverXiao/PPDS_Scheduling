...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT [txt_item_no], [txt_screw], [txt_die] FROM [Esch_Na_tbl_screw_die_by_item]" 
    DeleteCommand="DELETE FROM [Esch_Na_tbl_screw_die_by_item] WHERE ([txt_item_no] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Na_tbl_screw_die_by_item] SET [txt_screw] = ?, [txt_die] = ? WHERE ([txt_item_no] = ?)" 
            ...
            InsertCommand="INSERT INTO [Esch_Na_tbl_screw_die_by_item] ([txt_item_no], [txt_screw], [txt_die]) VALUES (?, ?, ?)" >
