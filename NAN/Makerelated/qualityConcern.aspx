...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    DeleteCommand="DELETE FROM [Esch_Na_tbl_qualityConcern] WHERE ([groupName] = ?) AND ([seqPerGroup] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Na_tbl_qualityConcern] SET [columnName] = ?, [relationOperator] = ?, [conditionValue] = ?, [extraDays] = ? WHERE ([groupName] = ?) AND ([seqPerGroup] = ?)" 
                                                                          
            
            
            
            InsertCommand="INSERT INTO [Esch_Na_tbl_qualityConcern] ([groupName], [seqPerGroup], [columnName], [relationOperator], [conditionValue], [extraDays]) VALUES (?, ?, ?, ?, ?, ?)" >
