...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT [txt_grade], [txt_line_no], [int_rate], [txtRemark] FROM [Esch_Na_tbl_output_by_line_by_grade]" 
    DeleteCommand="DELETE FROM [Esch_Na_tbl_output_by_line_by_grade] WHERE ([txt_grade] = ?) AND ([txt_line_no] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Na_tbl_output_by_line_by_grade] SET [int_rate] = ?, [txtRemark] = ? WHERE ([txt_grade] = ?) AND ([txt_line_no] = ?)" 
            
            
            
            InsertCommand="INSERT INTO [Esch_Na_tbl_output_by_line_by_grade] ([txt_grade], [txt_line_no], [int_rate], [txtRemark]) VALUES (?, ?, ?, ?)" >
