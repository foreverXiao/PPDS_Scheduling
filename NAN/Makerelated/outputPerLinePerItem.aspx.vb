...
Partial Class Makerelated_outputPerLinePerItem
        ...
        Try
            ...
            For Each rowexcel As DataRow In dtTbl.Rows
                ...
                If Not IsNumeric(rowexcel.Item("int_rate")) Then
                    msstring = "There is something wrong with row txt_item_no,txt_line_no :" & rowexcel("txt_item_no") & "," & rowexcel("txt_line_no") & "! Maybe int_rate is not a valid number."
                    Exit For
                End If
