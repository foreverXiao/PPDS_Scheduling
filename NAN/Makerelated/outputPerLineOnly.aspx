<%@ Page  aspcompat="true"  Title="Output per line only" Language="VB" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="false" CodeFile="outputPerLineOnly.aspx.vb" Inherits="Makerelated_outputPerLineOnly" Theme="Monochrome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    <asp:Label ID="Message"
      ...
      <asp:ListView ID="LV1" runat="server" ClientIDMode="Static" 
          DataSourceID="SDS1" DataKeyNames="int_line_no" 
    ...
    SelectCommand="SELECT [int_line_no], [int_rate], [txtRemark] FROM [Esch_Na_tbl_output_by_line_only]" 
    DeleteCommand="DELETE FROM [Esch_Na_tbl_output_by_line_only] WHERE ([int_line_no] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Na_tbl_output_by_line_only] SET [int_rate] = ?, [txtRemark] = ? WHERE ([int_line_no] = ?)" 
            
            
            
            
            InsertCommand="INSERT INTO [Esch_Na_tbl_output_by_line_only] ([int_line_no], [int_rate], [txtRemark]) VALUES (?, ?, ?)" >
