...
Partial Class plansetting_PrdctnLinesAndBatchNoGroup
    ...
    Public Overrides Function dataValidityCheck(ByRef dtTbl As DataTable) As String
        ...
        Dim columNameExist As String = getColumnNameOf_Esch_Na_tbl_orders().ToLower()
        ...
        Try
            ...
            For Each rowexcel As DataRow In dtTbl.Rows
                ...
                If rowexcel.Item("columnName").ToString.IndexOf("txt_") = 0 OrElse rowexcel.Item("columnName").ToString.ToLower = "int_line_no" Then 'wheter this is a string
                    If listOfoperatorForString.IndexOf("," & rowexcel.Item("relationOperator").ToString.ToLower.Trim() & ",") = -1 Then
                        msstring = " The value in field relationOperator should be one of these operators (" & listOfoperatorForString & ") <br /> with this row  batch no group: " & rowexcel.Item(1) & " columnName: " & rowexcel.Item("columnName")
                        Exit For
                    End If
                Else
                    If listOfoperatorForNonString.IndexOf("," & rowexcel.Item("relationOperator").ToString.ToLower.Trim() & ",") = -1 Then
                        msstring = " The value in field relationOperator should be one of these operators (" & listOfoperatorForNonString & ") <br /> with this row  batch no group: " & rowexcel.Item(1) & " columnName: " & rowexcel.Item("columnName")
                        Exit For
                    End If
                End If
                'column name has to be found in table Esch_Na_tbl_orders
    ...
    Protected Sub LV1_ItemInserting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ListViewInsertEventArgs) Handles LV1.ItemInserting
        ...
        For Each de As DictionaryEntry In e.Values
            ...
            If de.Key.ToString.IndexOf("relationOperator") > -1 Then
                ...
                If e.Values("columnName").ToString.IndexOf("txt_") = 0 OrElse e.Values("columnName").ToString.ToLower = "int_line_no" Then 'wheter this is a string
    ...
    Protected Sub LV1_ItemUpdating(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.ListViewUpdateEventArgs) Handles LV1.ItemUpdating
        ...
        For Each de As DictionaryEntry In e.NewValues
            ...
            Else
                If de.Key.ToString.IndexOf("relationOperator") > -1 Then
                    If e.NewValues("columnName").ToString.IndexOf("txt_") = 0 OrElse e.NewValues("columnName").ToString.ToLower = "int_line_no" Then 'wheter this is a string
                        If listOfoperatorForString.IndexOf("," & de.Value.ToString.ToLower.Trim() & ",") = -1 Then
                            messageText.Append(" The value in field relationOperator should be one of these operators (" & listOfoperatorForString & ") <br />")
                        End If
                    Else
