...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_Na_tbl_system_variable] ORDER BY [txtCategory], [txtVariableName]" 
    DeleteCommand="DELETE FROM [Esch_Na_tbl_system_variable] WHERE (([txtVariableName] = ?))" 
                                  
            UpdateCommand="UPDATE [Esch_Na_tbl_system_variable] SET [txtVariableValue] = ?, [txtVariableRemark] = ?, [txtCategory] = ? WHERE (([txtVariableName] = ?))" 
                                           
            
            
            InsertCommand="INSERT INTO [Esch_Na_tbl_system_variable] ([txtVariableName], [txtVariableValue], [txtVariableRemark], [txtCategory]) VALUES (?, ?, ?, ?)" >
