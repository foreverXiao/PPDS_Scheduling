...
Partial Class plansetting_batchNoSetting
    ...
    Public Overrides Function dataValidityCheck(ByRef dtTbl As DataTable) As String
        ...
        Dim emptyValueExist As Boolean

        Try
            For Each rowexcel As DataRow In dtTbl.Rows
                emptyValueExist = False

                For Each a In rowexcel.ItemArray
                    If DBNull.Value.Equals(a) Then
            ...
            If emptyValueExist Then
                msstring = "There is empty value in the "
            End If
        Catch
