...
Partial Class interface_explantFilesEDI
    Inherits basepage1
    ...
    Private Sub BindGrid()
        ...
        Dim files As FileInfo() = New DirectoryInfo(localpathsubfolder).GetFiles(valueOf("strExplantPrefix") & "." & valueOf("strOrganization") & "*")
