...
Partial Class interface_batchStatusFilesEDI
    Inherits basepage1
    ...
    Private Sub BindGrid()
        ...
        Dim files As FileInfo() = New DirectoryInfo(localpathsubfolder).GetFiles(valueOf("strBatchStatusUpdatePrefix") & "." & valueOf("strOrganization") & "*")
