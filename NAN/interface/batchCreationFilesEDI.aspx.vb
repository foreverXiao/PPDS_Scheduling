...
Partial Class interface_batchCreationFilesEDI
    Inherits basepage1
    ...
    Private Sub BindGrid()
        ...
        Dim files As FileInfo() = New DirectoryInfo(localpathsubfolder).GetFiles(valueOf("strBatchCreatorPrefix") & "." & valueOf("strOrganization") & "*")
