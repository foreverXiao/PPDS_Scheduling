...
Partial Public Class basepage1
    ...
    Enum priority  'show the priority of operation on table Esch_Na_tbl_orders
        ganttChart = 5
        addMTI = 6
        excelUpload = 6
    ...
    Private keytableName As String = "Esch_Na_tbl_orders"
    ...
    ''' <summary>
    ''' to initiate cache variable from table Esch_Na_tbl_system_variable
    ''' </summary>
