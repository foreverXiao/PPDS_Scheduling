...
Partial Class dragDrop_normalOP_combineProduction
    ...
    Protected Sub prdctnOrdrs_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles prdctnOrdrs.Click
        ...
        For Each dtrow0 As DataRow In dtTableFrom0.Select(Nothing, "[txt_item_no] ASC, [dat_start_date] ASC, [int_line_no] ASC") 'get order line data from table Esch_Na_tbl_orders
    ...
    Protected Sub bTdb_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bTdb.Click
        ...
        ''update back to table Esch_Na_tbl_orders
    ...
    Protected Sub prdctnOrdrs2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles prdctnOrdrs2.Click
        ...
        For Each dtrow0 As DataRow In dtTableFrom0.Select(Nothing, "[txt_item_no] ASC, [dat_etd] ASC") 'get order line data from table Esch_Na_tbl_orders
            Dim newRow As DataRow = dtTableUpdateTo.NewRow()
        ...
        SDS1.SelectCommand = "SELECT * FROM Esch_Na_tbl_similar_item_combination ORDER BY txt_item_no_similar ASC,txt_item_no ASC,dat_etd ASC, dat_start_date ASC , int_line_no ASC "
