...
&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Download1" runat="server" 
    ...
    SelectCommand="SELECT txt_order_key,int_status_key,txt_order_no,txt_order_line_no,txt_local_so,txt_item_no,flt_order_qty,planned_production_qty,dat_etd,int_line_no,txt_lot_no,dat_start_date,dat_finish_date,dat_new_explant,flt_working_hours,int_change_over_time,flt_actual_completed,dat_rdd,txt_currency,txt_destination,txt_ship_method,txt_gl_class,txt_grade,txt_color,txt_line_assign,int_span,txt_order_type,txt_orgn_code,txt_region_code,dat_order_added,dat_rev_ex_plant,flt_allocated_qty,txt_ship_cust,txt_clean_down,txt_remark,txt_line_comments,txt_from_whse,txt_ship_cust_no,txt_market_seg,txt_molder,txt_end_user,flt_sales_price,txt_ess_so,txt_ess_sol_no,txt_allocated_lots,txt_payment_term,txt_package_code,txt_tbd,txt_upload,txt_batch_status,txt_actual_line_no,dat_actual_start,dat_actual_finish,flt_actual_qty,flt_actual_qty_man,int_formula_version,txt_VIP,flt_unallocate_qty,txt_allocation_status,lng_VIP_lead_time,lng_AdvanceOfRevision,txt_payment_status,txt_order_status,txt_process_technics,dat_start_from_qa,flt_actual_qty_from_qa,txt_FDA,txt_remark_spcl,txt_auxiliary_code,txt_auxiliary_code_for_line_no,flt_margin,txt_FromUser,txt_ToUser
 FROM [Esch_Na_tbl_orders] ORDER BY [int_line_no], [dat_start_date]" 
    DeleteCommand="DELETE FROM [Esch_Na_tbl_orders] WHERE ([txt_order_key] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Na_tbl_orders] SET [int_status_key] = ?, [txt_order_no] = ?, [txt_order_line_no] = ?, [txt_local_so] = ?, [txt_item_no] = ?, [flt_order_qty] = ?, [planned_production_qty] = ?, [dat_etd] = ?, [int_line_no] = ?, [txt_lot_no] = ?, [dat_start_date] = ?, [dat_finish_date] = ?, [dat_new_explant] = ?, [flt_working_hours] = ?, [int_change_over_time] = ?, [flt_actual_completed] = ?, [dat_rdd] = ?, [txt_currency] = ?, [txt_destination] = ?, [txt_ship_method] = ?, [txt_gl_class] = ?, [txt_grade] = ?, [txt_color] = ?, [txt_line_assign] = ?, [int_span] = ?, [txt_order_type] = ?, [txt_orgn_code] = ?, [txt_region_code] = ?, [dat_order_added] = ?, [dat_rev_ex_plant] = ?, [flt_allocated_qty] = ?, [txt_ship_cust] = ?, [txt_clean_down] = ?, [txt_remark] = ?, [txt_line_comments] = ?, [txt_from_whse] = ?, [txt_ship_cust_no] = ?, [txt_market_seg] = ?, [txt_molder] = ?, [txt_end_user] = ?, [flt_sales_price] = ?, [txt_ess_so] = ?, [txt_ess_sol_no] = ?, [txt_allocated_lots] = ?, [txt_payment_term] = ?, [txt_package_code] = ?, [txt_tbd] = ?, [txt_upload] = ?, [txt_batch_status] = ?, [txt_actual_line_no] = ?, [dat_actual_start] = ?, [dat_actual_finish] = ?, [flt_actual_qty] = ?, [flt_actual_qty_man] = ?, [int_formula_version] = ?, [txt_VIP] = ?, [flt_unallocate_qty] = ?, [txt_allocation_status] = ?, [lng_VIP_lead_time] = ?, [lng_AdvanceOfRevision] = ?, [txt_payment_status] = ?, [txt_order_status] = ?, [txt_process_technics] = ?, [dat_start_from_qa] = ?, [flt_actual_qty_from_qa] = ?, [txt_FDA] = ?, [txt_remark_spcl] = ?, [txt_auxiliary_code] = ?, [txt_auxiliary_code_for_line_no] = ?, [flt_margin] = ?, [txt_FromUser] = ?, [txt_ToUser] = ? WHERE ([txt_order_key] = ?)" 
            
            
            
            
            InsertCommand="INSERT INTO [Esch_Na_tbl_orders] ([txt_order_key], [int_status_key], [txt_order_no], [txt_order_line_no], [txt_local_so], [txt_item_no], [flt_order_qty], [planned_production_qty], [dat_etd], [int_line_no], [txt_lot_no], [dat_start_date], [dat_finish_date], [dat_new_explant], [flt_working_hours], [int_change_over_time], [flt_actual_completed], [dat_rdd], [txt_currency], [txt_destination], [txt_ship_method], [txt_gl_class], [txt_grade], [txt_color], [txt_line_assign], [int_span], [txt_order_type], [txt_orgn_code], [txt_region_code], [dat_order_added], [dat_rev_ex_plant], [flt_allocated_qty], [txt_ship_cust], [txt_clean_down], [txt_remark], [txt_line_comments], [txt_from_whse], [txt_ship_cust_no], [txt_market_seg], [txt_molder], [txt_end_user], [flt_sales_price], [txt_ess_so], [txt_ess_sol_no], [txt_allocated_lots], [txt_payment_term], [txt_package_code], [txt_tbd], [txt_upload], [txt_batch_status], [txt_actual_line_no], [dat_actual_start], [dat_actual_finish], [flt_actual_qty], [flt_actual_qty_man], [int_formula_version], [txt_VIP], [flt_unallocate_qty], [txt_allocation_status], [lng_VIP_lead_time], [lng_AdvanceOfRevision], [txt_payment_status], [txt_order_status], [txt_process_technics], [dat_start_from_qa], [flt_actual_qty_from_qa], [txt_FDA], [txt_remark_spcl], [txt_auxiliary_code], [txt_auxiliary_code_for_line_no], [flt_margin], [txt_FromUser], [txt_ToUser]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)" >
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="int_formula_version" Type="Int16" />
