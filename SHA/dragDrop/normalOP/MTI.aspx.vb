...
Partial Class dragDrop_normalOP_MTI
    ...
    Protected Sub bckToDB_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles bckToDB.Click
        ...
        If String.IsNullOrEmpty(userName) Then
            ...
            Dim dtUpdateTo0 As SqlDataAdapter = New SqlDataAdapter("SELECT * FROM Esch_Sh_tbl_orders WHERE txt_order_key = ''", conn)
            ...
            Dim dtUpdateTo1 As SqlDataAdapter = New SqlDataAdapter("SELECT * FROM Esch_Sh_tbl_MTI_add WHERE decideToAdd = 1 ", conn)
