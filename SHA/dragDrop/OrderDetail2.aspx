...
&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Download1" runat="server" 
 ...
 FROM [Esch_Sh_tbl_orders] ORDER BY [int_line_no], [dat_start_date]" 
    DeleteCommand="DELETE FROM [Esch_Sh_tbl_orders] WHERE [txt_order_key] = @original_txt_order_key " 
