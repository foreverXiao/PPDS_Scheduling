...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT [minimum], [maximum], [txt_line_no] FROM [Esch_Sh_tbl_assign_line_by_order_qty] ORDER BY [minimum], [maximum]" 
    DeleteCommand="DELETE FROM [Esch_Sh_tbl_assign_line_by_order_qty] WHERE (([minimum] = ?)) AND (([maximum] = ?))" 
                                  
            UpdateCommand="UPDATE [Esch_Sh_tbl_assign_line_by_order_qty] SET [txt_line_no] = ? WHERE (([minimum] = ?)) AND (([maximum] = ?))" 
                                                           
                    
            
            InsertCommand="INSERT INTO [Esch_Sh_tbl_assign_line_by_order_qty] ([minimum], [maximum], [txt_line_no]) VALUES (?, ?, ?)" >
