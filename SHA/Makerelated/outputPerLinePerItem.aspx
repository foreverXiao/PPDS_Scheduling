...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT [txt_item_no], [txt_line_no], [int_rate], [txtRemark] FROM [Esch_Sh_tbl_output_by_line_by_item]" 
    DeleteCommand="DELETE FROM [Esch_Sh_tbl_output_by_line_by_item] WHERE ([txt_item_no] = ?) AND ([txt_line_no] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Sh_tbl_output_by_line_by_item] SET [int_rate] = ?, [txtRemark] = ? WHERE ([txt_item_no] = ?) AND ([txt_line_no] = ?)" 
            
            
            InsertCommand="INSERT INTO [Esch_Sh_tbl_output_by_line_by_item] ([txt_item_no], [txt_line_no], [int_rate], [txtRemark]) VALUES (?, ?, ?, ?)" >
