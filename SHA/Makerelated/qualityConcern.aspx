...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_Sh_tbl_qualityConcern] ORDER BY [groupName], [seqPerGroup]" 
    DeleteCommand="DELETE FROM [Esch_Sh_tbl_qualityConcern] WHERE ([groupName] = ?) AND ([seqPerGroup] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Sh_tbl_qualityConcern] SET [columnName] = ?, [relationOperator] = ?, [conditionValue] = ?, [extraDays] = ? WHERE ([groupName] = ?) AND ([seqPerGroup] = ?)" 
                                                                          
            
            
            
            InsertCommand="INSERT INTO [Esch_Sh_tbl_qualityConcern] ([groupName], [seqPerGroup], [columnName], [relationOperator], [conditionValue], [extraDays]) VALUES (?, ?, ?, ?, ?, ?)" >
