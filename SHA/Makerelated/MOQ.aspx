<%@ Page  aspcompat="true"  Title="MOQ" Language="VB" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="false" CodeFile="MOQ.aspx.vb" Inherits="Makerelated_MOQ" Theme="Monochrome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_Sh_tbl_MOQ] ORDER BY [groupName], [seqPerGroup]" 
    DeleteCommand="DELETE FROM [Esch_Sh_tbl_MOQ] WHERE ([groupName] = ?) AND ([seqPerGroup] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Sh_tbl_MOQ] SET [headerName] = ?, [relationOperator] = ?, [conditionValue] = ?, [remarkToBeAdded] = ? WHERE ([groupName] = ?) AND ([seqPerGroup] = ?)" 
            
            
            InsertCommand="INSERT INTO [Esch_Sh_tbl_MOQ] ([groupName], [seqPerGroup], [headerName], [relationOperator], [conditionValue], [remarkToBeAdded]) VALUES (?, ?, ?, ?, ?, ?)" >
