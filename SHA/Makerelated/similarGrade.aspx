...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT [grade], [typicalGrade] FROM [Esch_Sh_tbl_similar_grade_for_combination] ORDER BY [typicalGrade]" 
    DeleteCommand="DELETE FROM [Esch_Sh_tbl_similar_grade_for_combination] WHERE ([grade] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Sh_tbl_similar_grade_for_combination] SET [typicalGrade] = ? WHERE ([grade] = ?)" 
            
            
            
            
            InsertCommand="INSERT INTO [Esch_Sh_tbl_similar_grade_for_combination] ([grade], [typicalGrade]) VALUES (?, ?)" >
