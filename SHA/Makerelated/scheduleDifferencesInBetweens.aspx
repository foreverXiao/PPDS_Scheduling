...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SDS1" runat="server" 
        ...
        OldValuesParameterFormatString="original_{0}"
            ...
            SelectCommand="SELECT * FROM [Esch_Sh_tbl_differencesInBetweens] ORDER BY [txt_line_no], [dat_start_date]" 
            DeleteCommand="DELETE FROM [Esch_Sh_tbl_differencesInBetweens] WHERE ([txt_order_key] = ?) " 
            InsertCommand="INSERT INTO [Esch_Sh_tbl_differencesInBetweens] ([txt_line_no], [txt_item_no], [txt_lot_no], [planned_production_qty], [last_time_qty], [dat_start_date], [txt_order_key]) VALUES (?, ?, ?, ?, ?, ?, ?)" 
            UpdateCommand="UPDATE [Esch_Sh_tbl_differencesInBetweens] SET [txt_line_no] = ?, [txt_item_no] = ?, [txt_lot_no] = ?, [planned_production_qty] = ?, [last_time_qty] = ?, [dat_start_date] = ? WHERE ([txt_order_key] = ?)" >
