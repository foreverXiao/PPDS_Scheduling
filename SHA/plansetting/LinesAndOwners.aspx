...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_Sh_tbl_LinesAndOwners]" 
    DeleteCommand="DELETE FROM [Esch_Sh_tbl_LinesAndOwners] WHERE ([int_line_no] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Sh_tbl_LinesAndOwners] SET [txt_line_description] = ?, [txt_formula_version] = ?, [which_plant] = ?, [validuser] = ? WHERE ([int_line_no] = ?)" 
            ...
            InsertCommand="INSERT INTO [Esch_Sh_tbl_LinesAndOwners] ([int_line_no], [txt_line_description], [txt_formula_version], [which_plant], [validuser]) VALUES (?, ?, ?, ?, ?)" >
