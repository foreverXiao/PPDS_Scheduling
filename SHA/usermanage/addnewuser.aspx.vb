...
Partial Class usermanage_addnewuser
    ...
    Protected Sub btSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btSubmit.Click
        ...
        Try
            ...
            cmd.CommandText = "INSERT INTO [Esch_Sh_tbl_userrole]  ([user_name],[user_description],[password],[rightlevel]) VALUES(@LoginName, @description, @Password, @authorityLevel)"
            stReturn = cmd.ExecuteScalar()
            cmd.CommandText = "SELECT [user_name] FROM [Esch_Sh_tbl_userrole]  WHERE [user_name] = @LoginName "
            stReturn = cmd.ExecuteScalar()
