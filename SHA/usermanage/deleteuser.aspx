...
<asp:HyperLink ID="chngPsswrd"
    ...
    <asp:SqlDataSource ID="SDS1" runat="server" 
        ...
        DeleteCommand="DELETE FROM [Esch_Sh_tbl_userrole] WHERE ([user_name] = @user_name)"   
        
        SelectCommand="SELECT [user_name], [rightlevel], [user_description] FROM [Esch_Sh_tbl_userrole] ORDER BY [rightlevel], [user_name]" 
>
        <DeleteParameters>
