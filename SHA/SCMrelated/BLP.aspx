...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_Sh_tbl_BLP_new] ORDER BY [groupName], [seqPerGroup]" 
    DeleteCommand="DELETE FROM [Esch_Sh_tbl_BLP_new] WHERE ([groupName] = ?) AND ([seqPerGroup] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Sh_tbl_BLP_new] SET [headerName] = ?, [relationOperator] = ?, [conditionValue] = ?, [changeToCurrency] = ? WHERE ([groupName] = ?) AND ([seqPerGroup] = ?)" 
            
            
            InsertCommand="INSERT INTO [Esch_Sh_tbl_BLP_new] ([groupName], [seqPerGroup], [headerName], [relationOperator], [conditionValue], [changeToCurrency]) VALUES (?, ?, ?, ?, ?, ?)" >
