...
Partial Class SCMrelated_ordersLoading
    ...
    Protected Sub prdctnOrdrs_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles prdctnOrdrs.Click
        ...
        Dim dtAdapter1 As SqlDataAdapter = New SqlDataAdapter("SELECT planned_production_qty,dat_start_date,dat_finish_date,int_line_no,flt_working_hours,int_change_over_time,txt_VIP,txt_gl_class From Esch_Sh_tbl_orders " &
