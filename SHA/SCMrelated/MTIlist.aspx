...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT * FROM [Esch_Sh_tbl_MTI_List] ORDER BY [txt_MTI_item]" 
    DeleteCommand="DELETE FROM [Esch_Sh_tbl_MTI_List] WHERE ([txt_MTI_item] = ? )" 
                                  
            UpdateCommand="UPDATE [Esch_Sh_tbl_MTI_List] SET [dat_effective_date] = ?, [dat_expiration_date] = ?, [txt_remark] = ? WHERE ([txt_MTI_item] = ?) " 
                                           
            InsertCommand="INSERT INTO [Esch_Sh_tbl_MTI_List] ([txt_MTI_item], [dat_effective_date], [dat_expiration_date], [txt_remark]) VALUES (?, ?, ?, ?)" >
