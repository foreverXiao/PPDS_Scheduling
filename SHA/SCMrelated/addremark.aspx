<%@ Page  aspcompat="true"  Title="Add some remarks" Language="VB" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="false" CodeFile="addremark.aspx.vb" Inherits="SCMrelated_addremark" Theme="Monochrome" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    <asp:Label ID="Message"
      ...
      <asp:ListView ID="LV1" runat="server" ClientIDMode="Static" 
          DataSourceID="SDS1" DataKeyNames="groupName,sequence" 
          ...
          <AlternatingItemTemplate>
              <tr style="background-color:#FFF8DC; ">
                  ...
                  <td>
                      <asp:Label ID="remarkToBeAddedLabel" runat="server" 
                          Text='<%# Eval("remarkToBeAdded") %>' />
                  </td>
              </tr>
          </AlternatingItemTemplate>
          <EditItemTemplate>
              <tr style="background-color:#008A8C; color: #FFFFFF;">
                  ...
                  <td>
                       <asp:Label ID="sequenceLabel1" runat="server" 
                           Text='<%# Eval("sequence") %>' />
                  </td>
                  <td>
                  ...
                  <td>
                      <asp:TextBox ID="remarkToBeAddedTextBox" runat="server" 
                          Text='<%# Bind("remarkToBeAdded") %>' />
                  </td>
              </tr>
          </EditItemTemplate>
          <EmptyDataTemplate>
    ...
    <asp:SqlDataSource ID="SDS1" runat="server" 
        ConnectionString="Provider=Microsoft.ACE.OleDb.12.0;Data Source=C:\inetpub\wwwroot\SHA\App_Data\param.accdb" 
        ProviderName="System.Data.SqlClient"
        OldValuesParameterFormatString="original_{0}"
        
    SelectCommand="SELECT * FROM [Esch_Sh_tbl_remarkPerCondition]" 
    DeleteCommand="DELETE FROM [Esch_Sh_tbl_remarkPerCondition] WHERE ([groupName] = ?) AND ([sequence] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Sh_tbl_remarkPerCondition] SET [headerName] = ?, [relationOperator] = ?, [conditionValue] = ?, [remarkToBeAdded] = ? WHERE ([groupName] = ?) AND ([sequence] = ?)" 
                                           
            
            
            
            InsertCommand="INSERT INTO [Esch_Sh_tbl_remarkPerCondition] ([groupName], [sequence], [headerName], [relationOperator], [conditionValue], [remarkToBeAdded]) VALUES (?, ?, ?, ?, ?, ?)" >
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="remarkToBeAdded" Type="String" />
        </InsertParameters>
        <UpdateParameters>
            <asp:Parameter Name="headerName" Type="String" />
            <asp:Parameter Name="relationOperator" Type="String" />
