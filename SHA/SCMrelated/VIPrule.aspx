...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT [VIPgroup], [headerName], [Operator], [VIPCondition], [DaysOfCommittedLeadtime], [DaysAdvanceBeforeRevision], [ReservedCapPerWeek] FROM [Esch_Sh_tbl_VIP_lead_time] ORDER BY [VIPgroup], [DaysOfCommittedLeadtime]" 
    DeleteCommand="DELETE FROM [Esch_Sh_tbl_VIP_lead_time] WHERE (([VIPgroup] = ?)) AND (([headerName] = ?)) AND (([Operator] = ?)) AND (([VIPCondition] = ?))" 
                                  
            UpdateCommand="UPDATE [Esch_Sh_tbl_VIP_lead_time] SET [DaysOfCommittedLeadtime] = ?, [DaysAdvanceBeforeRevision] = ?, [ReservedCapPerWeek] = ? WHERE (([VIPgroup] = ?)) AND (([headerName] = ?)) AND (([Operator] = ?)) AND (([VIPCondition] = ?))" 
            ...
            InsertCommand="INSERT INTO [Esch_Sh_tbl_VIP_lead_time] ([VIPgroup], [headerName], [Operator], [VIPCondition], [DaysOfCommittedLeadtime], [DaysAdvanceBeforeRevision], [ReservedCapPerWeek]) VALUES (?, ?, ?, ?, ?, ?, ?)" >
