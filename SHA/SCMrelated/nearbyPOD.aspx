...
<asp:Content ID="Content2" ContentPlaceHolderID="CP1" Runat="Server">
    ...
    SelectCommand="SELECT [POD], [TypicalPOD], [txtRemark] FROM [Esch_Sh_tbl_same_POD_list_for_combination]" 
    DeleteCommand="DELETE FROM [Esch_Sh_tbl_same_POD_list_for_combination] WHERE ([POD] = ?)" 
                                  
            UpdateCommand="UPDATE [Esch_Sh_tbl_same_POD_list_for_combination] SET [TypicalPOD] = ?, [txtRemark] = ? WHERE ([POD] = ?)" 
                                           
            
            
            
            InsertCommand="INSERT INTO [Esch_Sh_tbl_same_POD_list_for_combination] ([POD], [TypicalPOD], [txtRemark]) VALUES (?, ?, ?)" >
