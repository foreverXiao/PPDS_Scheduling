...
Partial Class SCMrelated_ExportForGoldenRuleReport
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        'Dim dtAdapter1 As SqlDataAdapter = New SqlDataAdapter("SELECT txt_item_no,planned_production_qty,dat_start_date,dat_finish_date,int_line_no,txt_lot_no,txt_order_key,txt_local_so,int_span,txt_end_user,flt_working_hours,int_change_over_time,txt_grade,dat_new_explant,dat_etd,dat_rdd,dat_order_added From Esch_Sh_tbl_orders " &
        Dim dtAdapter1 As SqlDataAdapter = New SqlDataAdapter("SELECT txt_order_key,txt_lot_no,txt_allocated_lots,dat_finish_date,int_line_no,flt_order_qty,planned_production_qty From Esch_Sh_tbl_orders WHERE int_status_key Not In ('cancelled','invoiced')  ORDER BY int_line_no,dat_start_date", conn)
