...
Partial Public Class basepage1
    ...
    Enum priority  'show the priority of operation on table Esch_Sh_tbl_orders
        ganttChart = 5
        addMTI = 6
        excelUpload = 6
    ...
    Private keytableName As String = "Esch_Sh_tbl_orders"
    ...
    Public Sub initiateProductionLines()
        ...
        If CacheFrom("arrayOfLines") Is Nothing Then
            ...
            Dim command As New SqlCommand("Select distinct int_line_no From Esch_Sh_tbl_output_by_line_only ORDER BY int_line_no ASC", connParam)
    ...
    ''' <summary>
    ''' to initiate cache variable from table Esch_Sh_tbl_system_variable
    ''' </summary>
    Public Sub initiateCacheSystmVrbl()
        ...
        If CacheFrom("systemvariable") Is Nothing Then
            ...
            Dim command As SqlCommand = New SqlCommand("SELECT txtVariableValue , txtVariableName  FROM  [Esch_Sh_tbl_system_variable]", conn)
            Dim reader As SqlDataReader
